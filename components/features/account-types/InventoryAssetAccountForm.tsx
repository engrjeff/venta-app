...
export function InventoryAssetAccountForm({
  initialNameValue,
}: {
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      >
                        <FormControl>
                          <SelectTrigger>
                            <SelectValue placeholder="Current assets" />
                          </SelectTrigger>
                        </FormControl>
                        <SelectContent>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2 rounded-md bg-muted p-3 text-xs">
                  <p>
                    ...
                    to track the cost of goods your business purchases for
                    resale. When the goods are sold, assign the sale to a{" "}
                    <span className="font-semibold text-primary">
                      Cost of sales
                    </span>{" "}
                    account.
